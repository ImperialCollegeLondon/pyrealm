...
values <- within(values, {
       ...
       soilmstress_ar <- mapply(soilmstress, soilm_ar, meanalpha_ar)
       ...
       # rpmodel:::optimal_chi
       optchi_p14_sc <- rpmodel:::optimal_chi(kmm_sc, gammastar_sc, ns_star_sc,
                                                   ca_sc, vpd_sc, beta=146.0)
       optchi_p14_mx <- rpmodel:::optimal_chi(kmm_ar, gammastar_sc, ns_star_ar,
                                                   ca_sc, vpd_sc, beta=146.0)
       optchi_p14_ar <- rpmodel:::optimal_chi(kmm_ar, gammastar_ar, ns_star_ar,
...
for (rw in seq(nrow(luevcmax))){
    ...
    values[[test_name]] <- switch(inputs$lm,
                  'wang17' = rpmodel:::lue_vcmax_wang17(optchi_out, kphio=0.05,
                                ftemp_kphio=ftemp_kphio, soilmstress=soilmstress,
                                c_molmass=12.0107),
                  'smith19' = rpmodel:::lue_vcmax_smith19(optchi_out, kphio=0.05,
                                ftemp_kphio=ftemp_kphio, soilmstress=soilmstress,
                                c_molmass=12.0107),
                  'none' = rpmodel:::lue_vcmax_none(optchi_out, kphio=0.05,
                                ftemp_kphio=ftemp_kphio, soilmstress=soilmstress,
                                c_molmass=12.0107))
}
