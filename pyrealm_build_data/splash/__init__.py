r"""This module contains the code and inputs used to generate the SPLASH benchmark
datasets used in unit testing :mod:`~pyrealm.splash` and in regression tests against the
