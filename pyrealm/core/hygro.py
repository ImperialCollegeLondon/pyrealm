...
@_array_testing(_ArrayTesting(array_args=(ArrayArg("ta", 20),)))
...
@_array_testing(_ArrayTesting(array_args=(ArrayArg("vp", 1), ArrayArg("ta", 2))))
...
@_array_testing(_ArrayTesting(array_args=(ArrayArg("rh", 0.5), ArrayArg("ta", 20))))
...
@_array_testing(_ArrayTesting(array_args=(ArrayArg("sh", 0.06), ArrayArg("patm", 100))))
...
@_array_testing(
    _ArrayTesting(
        array_args=(ArrayArg("sh", 0.1), ArrayArg("ta", 20), ArrayArg("patm", 100000))
    )
)
...
@_array_testing(_ArrayTesting(array_args=(ArrayArg("tc", 20),)))
...
@_array_testing(_ArrayTesting(array_args=(ArrayArg("tc", 20), ArrayArg("p", 100000))))
