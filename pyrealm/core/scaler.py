"""The :mod:`~pyrealm.core.scaler` module provides the
:class:`~pyrealm.core.scaler.SubdailyScaler` class, which is a core
component of fitting the P Model at subdaily time scales. The class is used as follows:

* A :class:`~pyrealm.core.scaler.SubdailyScaler` instance is created using
...
* An acclimation window is then set, defining a period of the day representing the
  ...
  * The :meth:`~pyrealm.core.scaler.SubdailyScaler.set_window` method sets a
    window centred on a given time during the day with a fixed width.
  * The :meth:`~pyrealm.core.scaler.SubdailyScaler.set_nearest` method sets
    the acclimation window as the single observation closest to a given time of day.
  * The :meth:`~pyrealm.core.scaler.SubdailyScaler.set_include` method
  ...
  :meth:`~pyrealm.core.scaler.SubdailyScaler._set_times` method to update
...
* The :meth:`~pyrealm.core.scaler.SubdailyScaler.get_daily_means` method
  ...
  :meth:`~pyrealm.core.scaler.SubdailyScaler.get_window_values` method can
  be used to get the actual values observed during each daily window.

* The :meth:`~pyrealm.core.scaler.SubdailyScaler.fill_daily_to_subdaily`
  ...
  :class:`~pyrealm.core.scaler.SubdailyScaler` instance.
"""  # noqa: D205, D415
...
class SubdailyScaler:
    ...
    * completely cover a set of days.
    ...
    def _set_times(self) -> None:
        ...
        * :attr:`~pyrealm.core.scaler.SubdailyScaler.sample_datetimes`: An
          array of the datetimes of observations included in daily samples of shape
          (n_day, n_sample).
        * :attr:`~pyrealm.core.scaler.SubdailyScaler.sample_datetimes_mean`:
          An array of the mean daily datetime of observations included in daily samples.
        * :attr:`~pyrealm.core.scaler.SubdailyScaler.sample_datetimes_max`:
    ...
    def get_daily_means(
        ...
        effect if the
        :meth:`~pyrealm.core.scaler.SubdailyScaler.set_nearest` method has
    ...
    def fill_daily_to_subdaily(
        ...
        :class:`~pyrealm.core.scaler.SubdailyScaler` instance. The first
        ...
        * ``linear`` interpolates linearly between the update points of the daily
        ...
        Args:
            values: An array with the first dimension matching the number of days in the
                instances :class:`~pyrealm.core.scaler.SubdailyScaler` object.
